...
import static com.ebp.openQuarterMaster.baseStation.testResources.data.InternalTestUserService.TEST_PASSWORD_ATT_KEY;
...
public class LoginExternalTest extends WebUiTest {
    ...
    public void testLoginAdminWithToken() throws InterruptedException {
        UserGetResponse testUser = this.testUserService.getTestUser(true, true);
